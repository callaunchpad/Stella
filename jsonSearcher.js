...
**/
function finder(var thesaurus, var key){
  small = 0;
  big = thesaurus.length - 1;
...
**/
function binaryDictSearch(var thesaurus, var key, var small, var big){
...
**/
function findSynonym(var jsonEntry, var bayesBank){
